  ...
  <body>
    ...
    <div class="row" style="margin-top:40px;">
      ...
      <div class="col-10">
        ...
        <div class="box">
          <h1 class="display-4 text-center">Violin Lessons for Everyone</h1>
    ...
    <div class="row">
      <div class="col-md-4 col-lg-3 side-buffer"></div>
    ...
    <!-- INCLUDES -->
    <?php if(0) include("nav.php") ?>
    <?php if(0) include("footer.php"); ?>
